...
return [
    'Alias' => '别号',
    'Ordinal' => '序数词',
    'Since v1.6.6, set Alias to each field for a better WebHooks Add-On integration.' => '从v1.6.6开始，将Alias设置为每个字段以获得更好的WebHooks Add-On集成。',
    'The Form Builder fields have been successfully updated.' => '表单生成器字段已成功更新。',
    'Update Form Builder fields' => '更新表单生成器字段',
